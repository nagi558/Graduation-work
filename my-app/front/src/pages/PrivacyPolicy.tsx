    ...
    <div className="h-full bg-[#E8EEF1] flex items-start justify-center pt-20 pb-20">
      <div className="w-full max-w-2xl px-4">
        <div className="bg-white rounded-2xl shadow-sm p-8">
          ...
          <h1 className="text-2xl font-bold text-[#444444] mb-8">プライバシーポリシー</h1>

          <div className="text-sm text-gray-600 space-y-6 leading-relaxed">
            <p>
              「紡ぐレター」運営者（以下「運営者」）は、本サービス「紡ぐレター」（以下「本サービス」）における、
              ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」）を定めます。
            </p>

            <section>
              <h2 className="text-base font-bold text-[#444444] mb-2">第1条（個人情報）</h2>
              <p>
            ...
            <section>
              <h2 className="text-base font-bold text-[#444444] mb-2">第2条（個人情報の収集方法）</h2>
              <p>
                運営者は、ユーザーが利用登録をする際にメールアドレスなどの個人情報をお尋ねすることがあります。
                また、ユーザーと提携先などとの間でなされたユーザーの個人情報を含む取引記録や決済に関する情報を、
                運営者の提携先（情報提供元、広告主、広告配信先などを含みます。以下「提携先」）などから収集することがあります。
              </p>
            </section>

            <section>
              <h2 className="text-base font-bold text-[#444444] mb-2">第3条（個人情報を収集・利用する目的）</h2>
            ...
            <section>
              <h2 className="text-base font-bold text-[#444444] mb-2">第4条（利用目的の変更）</h2>
              <p>
            ...
            <section>
              <h2 className="text-base font-bold text-[#444444] mb-2">第5条（個人情報の第三者提供）</h2>
              <p>
            ...
            <section>
              <h2 className="text-base font-bold text-[#444444] mb-2">第6条（個人情報の開示）</h2>
              <p>
              ...
              <ul className="list-disc list-inside mt-2 space-y-1 pl-2">
                ...
                <li>運営者の業務の適正な実施に著しく支障を及ぼすおそれがある場合</li>
                <li>その他法令に違反することとなる場合</li>
              </ul>
            </section>

            <section>
              <h2 className="text-base font-bold text-[#444444] mb-2">第7条（個人情報の訂正および削除）</h2>
              <p>
                ユーザーは、運営者の保有する自己の個人情報が誤った情報である場合には、
                運営者が定める手続きにより、個人情報の訂正、追加または削除（以下「訂正等」）を請求することができます。
            ...
            <section>
              <h2 className="text-base font-bold text-[#444444] mb-2">第8条（個人情報の利用停止等）</h2>
              <p>
            ...
            <section>
              <h2 className="text-base font-bold text-[#444444] mb-2">第9条（プライバシーポリシーの変更）</h2>
              <p>
            ...
            <section>
              <h2 className="text-base font-bold text-[#444444] mb-2">第10条（お問い合わせ窓口）</h2>
              <p>
